...
Furthermore, the difficulty of programming DSP applications is often not commensurate with the creative intentions. \ruzica{something is fishy here, I cannot parse it}
...
In a single line \ruzica{, in an ideal case we would like to have}:
%
\begin{align*}
