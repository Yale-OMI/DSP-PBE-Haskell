...
We compare several different mutations of the current structure \brandon{what are these mutations?} and select the mutation that minimizes distance from our output file.
